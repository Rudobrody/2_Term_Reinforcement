...
def run_showcase(env, slider_agent, spawner_agent, filename='active_showcase.gif'):
...
for target in TARGETS:
    ...
    for i in tqdm(range(5000), desc=f"Training episodes for target {target}"):
    ...
    plt.legend()
    plt.savefig(f'win_rate_t{target}.png')
